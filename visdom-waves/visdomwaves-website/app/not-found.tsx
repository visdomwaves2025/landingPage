...
export default function NotFound() {
  return (
    <>
      <Header />
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-navy via-primary-blue to-primary-purple px-4 pt-20">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 md:p-12 border border-white/20">
              ...
              <div className="pt-8 border-t border-white/20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                  ...
                  <Link href="/products" className="text-white/90 hover:text-white hover:underline">
                    Products
                  </Link>
