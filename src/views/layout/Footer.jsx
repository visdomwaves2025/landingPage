...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#0f172a] text-white border-t border-white/5 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-primary-blue/20 to-transparent z-10"></div>
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary-blue/5 rounded-full blur-3xl z-10"></div>
            <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-purple/5 rounded-full blur-3xl z-10"></div>
            {/* Main Footer Content */}
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-3">
                                ...
                                <a
                                    ...
                                    className="text-neutral-400 hover:text-primary-blue transition-colors"
                                >
                            ...
                            <div className="flex items-start space-x-3">
                                <FiMapPin className="w-5 h-5 text-primary-blue mt-1" />
                        ...
                        <ul className="space-y-2">
                            {["Education", "Technology", "Consulting", "Healthcare", "Construction", "Temple Projects"].map(
                                (item) => (
                                    <li key={item}>
                                        <Link
                                            to={`/industries/${item.toLowerCase().replace(" ", "-")}`}
                                            className="text-neutral-400 hover:text-primary-blue transition-colors text-sm"
                                        >
                                            {item}
                                        </Link>
                                    </li>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            <a
                                ...
                                className="p-2 bg-white/5 hover:bg-primary-blue hover:text-brand-deepBlue rounded-full transition-all duration-300 hover:scale-110"
                                aria-label="LinkedIn"
                            >
