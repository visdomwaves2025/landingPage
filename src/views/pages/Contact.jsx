        ...
        <div className="min-h-screen">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative w-full h-96 rounded-2xl overflow-hidden shadow-2xl border border-neutral-200 group">
                        {/* Map Overlay Gradient */}
                        <div className="absolute inset-0 bg-gradient-to-t from-primary-navy/80 via-transparent to-transparent pointer-events-none z-10 opacity-60 group-hover:opacity-40 transition-opacity"></div>

                        <img
                            src="/images/contact-map.png"
                            alt="VisdomWaves Office Location Map - Hyderabad"
                            className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105"
                        />

                        {/* Location Pin Card */}
                        <div className="absolute bottom-6 left-6 z-20 bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-lg max-w-xs border border-white/50">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-primary-navy text-sm">Visdom Waves</h4>
                                    <p className="text-xs text-neutral-600 mt-1">
                                        Prabhat Signature Apartment<br />
                                        KPHB, Hyderabad
                                    </p>
                                    <a
                                        href="https://maps.google.com/?q=Visdom+Waves+Hyderabad"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-primary-blue text-xs font-semibold mt-2 block hover:underline"
                                    >
                                        Get Directions →
                                    </a>
                                </div>
