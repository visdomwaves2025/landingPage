    ...
    return (
        <div className="min-h-screen">
            ...
            <PageHero
                ...
                description="From live products to custom solutions - see what we've built and what we can create for you"
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
                                    ...
                                    <div className="lg:col-span-3 space-y-8">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                            <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg transform group-hover:scale-105 transition-transform duration-300">
                                                <img
                                                    src="/images/products/edtech-hero.png"
                                                    alt="EduWave Logo"
                                            ...
                                            <div className="relative z-10 h-full flex flex-col justify-end p-8 text-white">
                                                <div>
                                                    <div className="inline-flex items-center gap-2 mb-4">
                                                        ...
                                                        <span className="text-sm font-semibold uppercase tracking-wider backdrop-blur-md bg-white/10 px-3 py-1 rounded-full">Live Demo available</span>
                                                    </div>
                                                    <h4 className="text-3xl font-heading font-bold mb-4">
                                                        Try It Live
                                                    </h4>
                                                    <p className="text-white/90 text-lg leading-relaxed mb-6">
                                                        Experience our EdTech platform firsthand.
                                                    </p>
                                                </div>
