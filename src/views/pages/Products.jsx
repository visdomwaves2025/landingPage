...
import { getAllProducts } from "@/config/data/products";
    ...
    return (
        <div className="min-h-screen">
            ...
            <PageHero
                title={
                    <>
                        Ready-Made <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-vibrantTeal to-primary-blue">Products</span>
                    </>
                }
                description="Proven solutions designed for immediate deployment. No development time, just results."
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                                    ...
                                    <div className="lg:col-span-2 p-8 lg:p-10 bg-gradient-to-br from-primary-navy to-primary-blue text-white">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-3">
                                            <button
                                                onClick={(e) => handleDemoClick(e, `/products/${product.slug}`)}
                                    ...
                                    <div className="lg:col-span-3 p-8 lg:p-10">
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="rounded-2xl p-8 text-white relative overflow-hidden group/showcase">
                                                {/* Background Image */}
                                                <div className="absolute inset-0 z-0">
                                                    <img
                                                        src={product.showcaseImage}
                                                        alt={`${product.name} Preview`}
                                                        className="w-full h-full object-cover group-hover/showcase:scale-110 transition-transform duration-700"
                                                    />
